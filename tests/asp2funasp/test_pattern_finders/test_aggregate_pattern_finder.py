...
from clingo_funasp.ast import RewriteContext

from funasp.asp2funasp.pattern_finders.aggregate_pattern_finder import AggregatePatternFinder
from funasp.asp2funasp.util.types import FPredicate, CPredicate
