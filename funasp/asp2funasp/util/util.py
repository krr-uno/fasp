...
from typing import Dict, Iterable, List, Sequence, Tuple, TypeIs, TypeVar
...
def is_constraint(rule_head: ast.HeadLiteral) -> bool:
    """
...
) -> Tuple[Iterable[ast.Term], ast.Relation, Iterable[ast.Term]]:
    """
...
def split_multiple_aggregate_elements(
    lib: Library, node: ast.Statement
